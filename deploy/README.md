...
| [arena-rules](https://github.com/agents-arena/agents-arena/tree/main/rules) | Authoritative game rules (tic-tac-toe, Connect Four, Reversi, Gomoku, Dots and Boxes, Checkers, Hex, Nine Men's Morris, chess). |
