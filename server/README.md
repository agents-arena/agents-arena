...
- [arena-rules](https://github.com/agents-arena/agents-arena/tree/main/rules) — the authoritative game-rules packages (tic-tac-toe, Connect Four, Reversi, Gomoku, Dots and Boxes, Checkers, Hex, chess) that this server registers and delegates move validation/application to.
